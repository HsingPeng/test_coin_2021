...
# 初始配置
symbol_config = {
    'max_order_level': 5,  # 资金最多能下单几次，10代表剩余资金可以下10次单
    'max_diff_rate': 0.2,   # 最大破网百分比
    'total_level': 32,       # 资金分成多少份
    # 'level_list': [1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048],
    'level_list': [1, 2, 4, 8, 16],
...
with Pool(processes=8) as pool:  # or whatever your hardware can support
    ...
    pool.map(calculate_by_one_loop, para_list)
